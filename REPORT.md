...
- **Примечание**: в текущей реализации LangGraph (и некоторых частях LangChain) ключ llm_input_messages не является строго «зарезервированным» на уровне протокола или спецификации, но он поддерживается и используется внутри некоторых инструментов LangChain/LangGraph для отображения истории сообщений в дебаг-интерфейсах, логах и визуализациях.
